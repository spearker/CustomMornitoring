...
const OutsourcingRegister = ({match}: any) => {
  ...
  const getData = useCallback(async () => {
    ...
    const res = await postRequest(`http://61.101.55.224:18299/api/v1/outsourcing/load`, {pk: match.params.pk}, getToken(TOKEN_NAME))
  ...
  const onsubmitFormUpdate = useCallback(async (e) => {
    ...
    const res = await postRequest('http://61.101.55.224:18299/api/v1/outsourcing/update/', data, getToken(TOKEN_NAME))
  ...
  const onsubmitForm = useCallback(async (e) => {
    ...
    const res = await postRequest('http://61.101.55.224:18299/api/v1/outsourcing/register', data, getToken(TOKEN_NAME))
