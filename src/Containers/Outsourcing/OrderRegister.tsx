...
const OutsourcingRegister = ({match}: Props) => {
    ...
    const getData = useCallback(async () => {
        ...
        const res = await getRequest('http://222.100.89.245:8299/api/v1/outsourcing/order/load?pk=' + match.params.pk, getToken(TOKEN_NAME))
    ...
    const onsubmitFormUpdate = useCallback(async () => {
        ...
        const res = await postRequest('http://222.100.89.245:8299/api/v1/outsourcing/oder/update/', data, getToken(TOKEN_NAME))
    ...
    const onsubmitForm = useCallback(async () => {
        ...
        const res = await postRequest('http://222.100.89.245:8299/api/v1/outsourcing/order/register', data, getToken(TOKEN_NAME))
