...
const ContractRegister = ({match}:Props) => {
    ...
    const getData = useCallback(async()=>{
        ...
        const res = await getRequest('http://61.101.55.224:8299/api/v1/outsourcing/contract/load?pk=' + match.params.pk , getToken(TOKEN_NAME))
    ...
    const onsubmitFormUpdate = useCallback(async(e)=>{
        ...
        const res = await postRequest('http://61.101.55.224:8299/api/v1/outsourcing/contract/update/', data, getToken(TOKEN_NAME))
    ...
    const onsubmitForm = useCallback(async()=>{
        ...
        const res = await postRequest('http://61.101.55.224:8299/api/v1/outsourcing/contract/register', data, getToken(TOKEN_NAME))
