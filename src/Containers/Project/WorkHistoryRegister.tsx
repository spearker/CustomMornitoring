                ...
                <div>
                    <table style={{color: 'black'}}>
                        ...
                        <tr>
                            <td>• 품목(품목명)</td>
                            <td>
                                <ProductionPickerModal disabled={isUpdate} select={modalSelect.production}
                                                       onClickEvent={(e) => {
                        ...
                        <tr>
                            <td>• 기계명</td>
                            <td>
                                <MachinePickerModal disabled={isUpdate} select={modalSelect.machine}
                                                    onClickEvent={(e) => {
