          ...
          <table style={{color: 'black'}}>
                ...
                <td>
                  <div style={{display: 'flex', width: 920, justifyContent: 'space-between'}}>
                    <div style={{width: 400, border: '0.5px solid #b3b3b3'}}>
                      {
                        !isUpdate && <ProductionPickerModal width={true} multiSelect innerWidth={400} isType
                      ...
                      <div>
                        {
                          ...
                          detailMaterialData.input_materials && detailMaterialData.input_materials.length !== 0
                                    ...
                                    <div style={{flex: 1, textAlign: 'left'}}>
                                      {
                                        isUpdate ? value.count
                                          : <input style={{width: '95%'}} type={'number'} value={value.count}
                                                   onChange={(e) => {
                            ...
                            : <div style={{padding: '10px 0 10px 0', textAlign: 'center'}}>투입품목을 선택해주세요.</div>
                        }
                      </div>
                    </div>
                    <div style={{width: 400, border: '0.5px solid #b3b3b3'}}>
                          ...
                          detailMaterialData && detailMaterialData.output_materials
                            ? <div style={{width: '100%', height: 'auto'}}>
                              ...
                              <div style={{display: 'flex', marginTop: 5, padding: 5}}>
                                ...
                                <div style={{flex: 1, textAlign: 'left'}}>{
                                  //@ts-ignore
                                  detailMaterialData.output_materials.material_type
                                }</div>
                                <div style={{flex: 1, textAlign: 'left'}}>
                                  {
                            ...
                            : <div style={{padding: '10px 0 10px 0', textAlign: 'center'}}>생산품목을 선택해주세요.</div>
                        }
                      </div>
                    </div>
                  </div>
            ...
            <tr>
              ...
              <td>
                {
                  isUpdate
                    ? <InputBox disabled={isUpdate} value={detailMaterialData && detailMaterialData.machine_name}
                                placeholder={'총 작업량을 입력해 주세요'}></InputBox>
            ...
            </tr>
            {
              detailMaterialData.machine_type && detailMaterialData.machine_type === 1 && <tr>
                  ...
                  <td>
                    {
                      isUpdate
                        ? <InputBox disabled={isUpdate} value={detailMaterialData && detailMaterialData.mold_name}
                                    placeholder={'총 작업량을 입력해 주세요'}></InputBox>
