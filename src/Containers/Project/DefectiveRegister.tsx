...
const DefectiveRegisterContainer = ({ match }: Props)  => {
    ...
    const onsubmitFormUpdate = useCallback(async()=>{
        ...
        const res = await postRequest('http://61.101.55.224:8299/api/v1/defective/update/', data, getToken(TOKEN_NAME))
    ...
    const onsubmitForm = useCallback(async()=>{
        ...
        const res = await postRequest('http://61.101.55.224:8299/api/v1/defective/register', data, getToken(TOKEN_NAME))
