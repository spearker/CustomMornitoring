...
const ContractRegisterContainer = () => {
  ...
  const [selectMaterial, setSelectMaterial] = useState<{ name?: string, pk?: string, stock?: number }>()
      ...
      <ContainerMain>
        ...
        <div>
          <table style={{color: 'black'}}>
            ...
            <tr>
              <td>• 품목(품목명)</td>
              <td><ProductionPickerModal select={selectMaterial}
                                         onClickEvent={(e) => e !== undefined ? setSelectMaterial({
              ...
              <td>
                <div style={{
                  ...
                  <ColorCalendarDropdown unLimit={true} select={selectDate}
                                         ...
                                         customStyle={{height: 32, marginLeft: 0, zIndex: 1}}/>
                </div>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <div style={{
                  ...
                  <ColorCalendarDropdown unLimit={true} select={finishDate}
                                         ...
                                         customStyle={{height: 32, marginLeft: 0, zIndex: 0}}/>
                </div>
              </td>
            </tr>
          </table>
