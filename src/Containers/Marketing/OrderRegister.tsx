...
import {API_URLS, postOrderRegister} from "../../Api/mes/business";
            ...
            <ContainerMain>
                ...
                <div>
                    <table style={{color: "black"}}>
                        ...
                        <tr>
                            <td>• 수량</td>
                            <td><Input placeholder="수주 리스트가 입력되면 자동 입력됩니다." onChangeText={(e:number) => setOrderData({...orderData, amount: e})}/></td>
                        </tr>
                        <tr>
                            <td>• 수주 날짜</td>
                            <td>
