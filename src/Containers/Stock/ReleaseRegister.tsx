...
const ReleaseRegisterContainer = ({match}: Props) => {
    ...
    const getData = useCallback(async () => {
        ...
        const res = await getRequest('http://192.168.0.21:8299/api/v1/customer/view?pk=' + getParameter('pk'), getToken(TOKEN_NAME))
    ...
    const onsubmitFormUpdate = useCallback(async (e) => {
        ...
        const res = await postRequest('http://192.168.0.21:8299/api/v1/customer/update/', data, getToken(TOKEN_NAME))
    ...
    const onsubmitForm = useCallback(async () => {
        if (match.params.parts) {
            ...
            const res = await postRequest('http://192.168.0.21:8299/api/v1/stock/parts/release/register', data, getToken(TOKEN_NAME))
            ...
            const res = await postRequest('http://192.168.0.21:8299/api/v1/stock/release/register', data, getToken(TOKEN_NAME))
