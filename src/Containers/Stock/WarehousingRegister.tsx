...
const WarehousingRegisterContainer = ({ match }: Props) => {
    ...
    const onsubmitForm = useCallback(async()=>{
        ...
        if(match.params.parts){
            ...
            const res = await postRequest('http://293.234.183.22:8299/api/v1/stock/parts/warehousing/register', data, getToken(TOKEN_NAME))
            ...
            const res = await postRequest('http://293.234.183.22:8299/api/v1/stock/warehousing/register', data, getToken(TOKEN_NAME))
