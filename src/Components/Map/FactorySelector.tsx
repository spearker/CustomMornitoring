...
const FactorySelector = ({ list, select, onChangeEvent, width }: Props) => {
  ...
  return (
      <Wrapper width={width}>
        <img src={IC_BEFORE} onClick={() => {
          onClickStep('BEFORE')
        }}/>

        {select.name}

        <img src={IC_AFTER} onClick={() => {
          onClickStep('AFTER')
        }}/>
      </Wrapper>
...
const Wrapper: any = Styled.div`
    max-width: ${(props: any) => props.width ? props.width : '1100px !important;'}
    height: 30px;
