...
const CustomAnalysisDashboardPressStatus: React.FunctionComponent<Props> = ({id, first, check, onChange}) => {
    ...
    return (
        <div>
            ...
            <ListBox>
                {
                    autoCustomType() === 'hwain_trans' || autoCustomType() === 'jaewoo_material_trans' || autoCustomType() === 'teoul_trans' || autoCustomType() === 'atech_trans' || autoCustomType() === 'hangil_trans' || autoCustomType() === 'jeonghyun_trans' || autoCustomType() === 'daekwang_trans' || autoCustomType() === 'daeheung_trans' && onChange !== undefined ?
