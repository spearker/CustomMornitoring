            ...
            <div style={{display: 'flex'}}>
                ...
                <div style={{width: '770px', height: '200px', display: 'flex', flexWrap: 'wrap',}}>
                    ...
                    <PressStatusBox title={'종합 카운터'}
                                    ...
                                    fontSize={'22px'}/>
                    <PressStatusBox title={'기계 가동시간'} value={machineData.runtime} fontSize={'22px'}/>
                    <PressStatusBox title={'기계 비가동시간'} value={machineData.downtime} fontSize={'22px'}/>
                    <PressStatusBox title={'기계 가동률'} value={`${machineData.percent}%`} fontSize={'30px'}/>
