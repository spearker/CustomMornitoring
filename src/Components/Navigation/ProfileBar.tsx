        ...
        <SearchBarWrapDiv>
            <SearchBarInnerDiv>
                <div style={{display:'flex', alignItems: 'center', width:'100%' }}>
                  ...
                  {window.location.href.indexOf('/dashboard') !== -1 && <p  className="p-bold" > 대시보드 홈</p>}
                  {window.location.href.indexOf('/pm') !== -1 && nav.mode === 'mes'|| window.location.href.indexOf('/dashboard') == -1 && nav.mode === 'home' && <p  className="p-bold"> {title}</p>}
                  {window.location.href.indexOf('/dashboard') == -1 && nav.mode === 'pm' && <p  className="p-bold"> {title}</p>}
                  {window.location.href.indexOf('/dashboard') == -1 && nav.mode === 'mes' && <p  className="p-bold"> {title}</p>}
