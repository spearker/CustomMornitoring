    ...
    <div style={style}>
      <EnrollmentBorderBox>
        ...
        {addIsOpen && addInputType === 'input' && <InputBox style={{marginTop: 8}}>
          ...
          <p>&nbsp;</p>
          <div>
            <input type={addType ? addType : 'text'} placeholder={addPlaceholder ? addPlaceholder : ''} value={addValue ? addValue : ''} onChange={(e) => {onAddChangeEvent(e.target.value)}} />    
            {addUnit && <p>{addUnit}</p>}
          </div>
        </InputBox>}
                        ...
                        <tr style={{height: 32}}>
                          ...
                          <td>
                            <button
                              ...
                              onClick={() => {
                                onClickEvent({type: v.material_type, pk: v.pk, name: v.material_name})
                                if(onAddChangeEvent){
                                  onAddChangeEvent('')
                                }
                              }}
