...
const DateTypeCalendar = ({type, selectDate, selectDates, onChangeSelectDate, style}: Props) => {
    ...
    return (
        <DropBoxContainer ref={ref} style={style}>
            <BoxWrap onClick={() => setIsOpen(!isOpen)} style={{zIndex: 1}}>
