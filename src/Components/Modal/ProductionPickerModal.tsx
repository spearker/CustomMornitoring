...
const ProductionPickerModal = ({select, selectRange, onClickEvent, text, width, type, style, innerStyle, innerWidth, buttonWid, disabled, isType, multiSelect, isAllItem, noBasic, filter}: IProps) => {
