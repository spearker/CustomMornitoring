    ...
    <div>
      {
        ...
        <Switch>
          ...
          {/* 생산관리 */}
            ...
            <Route exact path="/project/history/register/:version" component={WorkHistoryRegister}/>
          ...
          {/*신규 원자재 관리*/}
            ...
            <Route exact path="/basic/material/register/v2/:pk" component={NewBasicMaterialRegister_V2}/>
