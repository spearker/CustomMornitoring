...
const CreateMember = () => {
    ...
    const onClickCreateMember = useCallback(async () => {
        ...
        <DashboardWrapContainer index={'manage'}>
            <InnerBodyContainer>
                            ...
                            userInfo.map((v, i) => {
                                return (
                                    <tr>
                                        ...
                                        <td>
                                            <Input key={`password-${i}`} type={'password'} value={userInfo[i].password}
                                                   onChange={(e) => {
                                                       let tmpUserInfo = userInfo
                ...
                <div style={{width: 450, display: 'flex', justifyContent: 'space-around', marginTop: 50}}>
                    ...
                    <BasicColorButton name={'등록'} onClickEvent={() => onClickCreateMember()}/>
                </div>
            </InnerBodyContainer>
