...
const AcceptMember = () => {
  ...
  const getList = useCallback(async () => {
    const results = await getRequest('http://183.99.194.242:8299/api/v1/member/load/temp', getToken(TOKEN_NAME))
  ...
  const onClickAccept = useCallback(async (id) => {
    ...
    const results = await postRequest('http://183.99.194.242:8299/api/v1/member/accept', { user_pk: id }, getToken(TOKEN_NAME))
