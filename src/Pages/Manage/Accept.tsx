...
const AcceptMember = () => {
  ...
  const getList = useCallback(async ()=> {
    const results = await getRequest('http://211.208.115.66:8091/api/v1/member/load/temp', getToken(TOKEN_NAME))
  ...
  const onClickAccept = useCallback(async(id)=>{
    ...
    const results = await postRequest('http://211.208.115.66:8091/api/v1/member/accept', {user_pk:id} ,getToken(TOKEN_NAME))
