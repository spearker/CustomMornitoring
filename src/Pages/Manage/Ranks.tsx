...
const Ranks = () => {
  ...
  const onClickSave = useCallback(async () => {
    ...
    const results = await postRequest('http://183.99.194.242:8299/api/v1/admin/appointment/update', data, getToken(TOKEN_NAME))
                ...
                list.map((v, i) => {
                  return (
                      <div key={i} style={{ display: 'flex', marginTop: 16 }}>
                        <InputBox value={v} onChange={(e) => {
                          onChangeListName(e, i)
                        }}/>
                        <div>
                          <a onClick={() => onClickModify('UP', i)}><img style={{ height: 40, marginRight: 10 }}
                                                                         src={BTN_UP}/></a>
                          <a onClick={() => onClickModify('DOWN', i)}><img src={BTN_DOWN}
                                                                           style={{ width: 40, marginRight: 10 }}/></a>
