...
const RegisterInferior = () => {
  ...
  const getData = useCallback(async()=>{
    ...
    const res = await getRequest('http://293.234.183.22:8299/api/v1/process/view?pk=' + getParameter('pk'), getToken(TOKEN_NAME))
  ...
  const onsubmitForm = useCallback(async(e)=>{
    ...
    const res = await postRequest('http://293.234.183.22:8299/api/v1/stock/out', data, getToken(TOKEN_NAME))
  ...
  const onsubmitFormUpdate = useCallback(async(e)=>{
   ...
   const data = {
    ...
    const res = await postRequest('http://293.234.183.22:8299/api/v1/barcode/product/update' + getParameter('pk'), data, getToken(TOKEN_NAME))
