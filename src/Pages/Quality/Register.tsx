...
const RegisterInferior = () => {
  ...
  const onsubmitForm = useCallback(async (e) => {
    ...
    const res = await postRequest('http://183.99.194.242:8299/api/v1/stock/out', data, getToken(TOKEN_NAME))
  ...
  const onsubmitFormUpdate = useCallback(async (e) => {
    ...
    const res = await postRequest('http://183.99.194.242:8299/api/v1/barcode/product/update' + getParameter('pk'), data, getToken(TOKEN_NAME))
