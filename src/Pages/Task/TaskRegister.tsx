 ...
 const [tab, setTab] = useState<string>(tabList[0]);
  ...
  /**
    ...
    const getRecommendData = useCallback(async()=>{
      ...
      const res = await getRequest('http://112.186.20.155:8299/api/v1/task/recommend?pk=' + encodeURIComponent(keyword), getToken(TOKEN_NAME))
  ...
  const onClickSearchMaterial = useCallback(async(e)=>{
    ...
    const res = await getRequest('http://112.186.20.155:8299/api/v1/material/search?keyword=' + keyword, getToken(TOKEN_NAME))
  ...
  const onsubmitFormUpdate = useCallback(async(e)=>{
    ...
    const res = await postRequest('http://112.186.20.155:8299/api/v1/task/update', data, getToken(TOKEN_NAME))
  ...
  const onsubmitForm = useCallback(async(e)=>{
    ...
    const res = await postRequest('http://112.186.20.155:8299/api/v1/task/register', data, getToken(TOKEN_NAME))
  ...
  const getData = useCallback(async()=>{
    ...
    const res = await getRequest('http://112.186.20.155:8299/api/v1/task/view?pk=' + getParameter('pk'), getToken(TOKEN_NAME))
  ...
  const onSubmitFile = useCallback(async(id)=>{
    ...
    const res = await postRequest('http://112.186.20.155:8299/api/v1/task/file',data, getToken(TOKEN_NAME))
