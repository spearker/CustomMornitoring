...
const BarCodeList = () => {
  ...
  const onClickFilter = useCallback(async (filter: number) => {
    ...
    const results = await getRequest('http://112.168.150.239:8299/api/v1/barcode/list?orderBy=' + filter + '&keyword=' + keyword, getToken(TOKEN_NAME))
  ...
  return (
      <DashboardWrapContainer index={4}>
        ...
        <InnerBodyContainer>
          ...
          <NormalTable widthList={[ '140px', '140px', '240px', '140px', '140px' ]} indexList={index} keyName={'pk'}
