...
const ProductList = () => {
  ...
  const getSearchList = useCallback(async (e)=>{
    e.preventDefault();
    const results = await getRequest('http://61.101.55.224:9912/api/v1/barcode/product/load?keyword='+ keyword +'&orderBy=' + option ,getToken(TOKEN_NAME))
  ...
  const onClickDelete = useCallback(async (id)=>{
    ...
    const results = await postRequest('http://61.101.55.224:9912/api/v1/barcode/product/delete', {material_pk:id}, getToken(TOKEN_NAME))
