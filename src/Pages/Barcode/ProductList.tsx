...
const ProductList = () => {
    ...
    const onClickDelete = useCallback(async (id) => {
        ...
        const results = await postRequest('http://211.208.115.66:8199/api/v1/barcode/product/delete', {material_pk: id}, getToken(TOKEN_NAME))
        ...
        <DashboardWrapContainer index={4}>
            ...
            <InnerBodyContainer>
                ...
                <InfoTable indexList={index} pkKey={'pk'} type={'barcode'} typeKey={'type'}
                           typeChanger={machineCodeToName} onClickLinkUrl="/connect/barcode/update?pk=" contents={list}
