...
const Old_ProductList = () => {
    ...
    const getSearchList = useCallback(async (e) => {
        e.preventDefault();
        const results = await getRequest('http://222.100.89.245:8299/api/v1/barcode/product/load?keyword=' + keyword + '&orderBy=' + option, getToken(TOKEN_NAME))
    ...
    const onClickDelete = useCallback(async (id) => {
        ...
        const results = await postRequest('http://222.100.89.245:8299/api/v1/barcode/product/delete', {material_pk: id}, getToken(TOKEN_NAME))
