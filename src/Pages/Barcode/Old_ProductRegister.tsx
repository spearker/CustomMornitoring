...
const Old_ProductRegister = () => {
  ...
  const getData = useCallback(async () => {
    ...
    const res = await getRequest('http://192.168.0.46:8299/api/v1/barcode/product/view?pk=' + getParameter('pk'), getToken(TOKEN_NAME))
  ...
  const onsubmitForm = useCallback(async (e) => {
    ...
    const res = await postRequest('http://192.168.0.46:8299/api/v1/barcode/product/register', data, getToken(TOKEN_NAME))
  ...
  const onsubmitFormUpdate = useCallback(async (e) => {
    ...
    const res = await postRequest('http://192.168.0.46:8299/api/v1/barcode/product/update', data, getToken(TOKEN_NAME))
