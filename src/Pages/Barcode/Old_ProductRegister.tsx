...
const Old_ProductRegister = () => {
  ...
  const getData = useCallback(async () => {
    ...
    const res = await getRequest('http://61.101.55.224:18299/api/v1/barcode/product/view?pk=' + getParameter('pk'), getToken(TOKEN_NAME))
  ...
  const onsubmitForm = useCallback(async (e) => {
    ...
    const res = await postRequest('http://61.101.55.224:18299/api/v1/barcode/product/register', data, getToken(TOKEN_NAME))
  ...
  const onsubmitFormUpdate = useCallback(async (e) => {
    ...
    const res = await postRequest('http://61.101.55.224:18299/api/v1/barcode/product/update', data, getToken(TOKEN_NAME))
