...
const StockChangeIn = () => {
  ...
  const onsubmitForm = useCallback(async(e)=>{
    ...
    const res = await postRequest('http://112.168.150.239:8299/api/v1/stock/in', data, getToken(TOKEN_NAME))
      ...
      <DashboardWrapContainer index={8}>
        ...
        <InnerBodyContainer>
            ...
            <WhiteBoxContainer>
             ...
             <RadioInput title={'입고 구분'} target={type} onChangeEvent={setType} contents={[{value:3, title:'정상 입고'}, {value:4, title:'생산'}, {value:9, title:'기타 (오류정정)'}]}/>
