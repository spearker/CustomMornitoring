...
const MaterialList = () => {
  ...
  const onClickFilter = useCallback(async (filter: number) => {
    setOption(filter)
    const results = await getRequest('http://183.99.194.242:8299/api/v1/material/list/' + filter, getToken(TOKEN_NAME))
  ...
  const getList = useCallback(async () => {
    ...
    const results = await getRequest('http://183.99.194.242:8299/api/v1/material/list/0', getToken(TOKEN_NAME))
