...
const OutsourcingList = () => {
  ...
  const getSearchList = useCallback(async (e) => {
    e.preventDefault()
    const results = await getRequest('http://61.101.55.224:18299/api/v1/outsourcing/list?keyword=' + keyword + '&orderBy=' + option, getToken(TOKEN_NAME))
  ...
  const onClickDelete = useCallback(async (id) => {
    ...
    const results = await postRequest('http://61.101.55.224:18299/api/v1/customer/delete', {pk: id}, getToken(TOKEN_NAME))
