...
const OutsourcingList = () => {
  ...
  const getSearchList = useCallback(async (e) => {
    e.preventDefault();
    const results = await getRequest('http://183.99.194.242:8299/api/v1/outsourcing/list?keyword=' + keyword + '&orderBy=' + option, getToken(TOKEN_NAME))
  ...
  const onClickDelete = useCallback(async (id) => {
    ...
    const results = await postRequest('http://183.99.194.242:8299/api/v1/customer/delete', { pk: id }, getToken(TOKEN_NAME))
  ...
  return (
      <DashboardWrapContainer index={3}>
        ...
        <InnerBodyContainer>
          ...
          <InfoTable indexList={index} type={'client'} pkKey={'pk'} onClickLinkUrl="/update/client?pk=" contents={list}
