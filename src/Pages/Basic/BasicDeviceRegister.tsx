...
const BasicDeviceRegister = () => {
  ...
  const getData = useCallback(async () => {
    ...
    const res = await getRequest('http://192.168.0.46:8299/api/v1/device/load?pk=' + getParameter('pk'), getToken(TOKEN_NAME))
  ...
  const onsubmitFormUpdate = useCallback(async (e) => {
    ...
    const res = await postRequest('http://192.168.0.46:8299/api/v1/device/update/', data, getToken(TOKEN_NAME))
  ...
  const onsubmitForm = useCallback(async (e) => {
    ...
    const res = await postRequest('http://192.168.0.46:8299/api/v1/device/register', data, getToken(TOKEN_NAME))
          ...
          <WhiteBoxContainer>
            {
              ...
              <form onSubmit={isUpdate ? onsubmitFormUpdate : onsubmitForm}>
                ...
                <BasicSearchContainer
                    ...
                    solo={true}
                    list={factory}
                    searchUrl={'http://192.168.0.46:8299/api/v1/factory/search?page=1&limit=15&'}
                />
                <br/>
                ...
                {/*  loadDataUrl={isUpdate? `http://192.168.0.46:8299/api/v1/device/load?pk=${pk}` :''}*/}
