...
const BasicPartsRegister = () => {
  ...
  const partsListLoad = useCallback(async () => {
    ...
    const res = await getRequest('http://255.255.255.255:8299/api/v1/parts/type/list', getToken(TOKEN_NAME))
  ...
  const getData = useCallback(async () => {
    ...
    const res = await getRequest('http://255.255.255.255:8299/api/v1/parts/load?pk=' + getParameter('pk'), getToken(TOKEN_NAME))
  ...
  const onsubmitFormUpdate = useCallback(async () => {
    ...
    const res = await postRequest('http://255.255.255.255:8299/api/v1/parts/update', data, getToken(TOKEN_NAME))
  ...
  const onsubmitForm = useCallback(async () => {
    ...
    const res = await postRequest('http://255.255.255.255:8299/api/v1/parts/register', data, getToken(TOKEN_NAME))
  ...
  const partsRegister = useCallback(async () => {
    ...
    const res = await postRequest('http://255.255.255.255:8299/api/v1/parts/type/register', data, getToken(TOKEN_NAME))
  ...
  const partsDelete = useCallback(async () => {
    ...
    const res = await postRequest('http://255.255.255.255:8299/api/v1/parts/type/delete', data, getToken(TOKEN_NAME))
  ...
  const partsUpdate = useCallback(async () => {
    ...
    const res = await postRequest('http://255.255.255.255:8299/api/v1/parts/type/update', data, getToken(TOKEN_NAME))
