...
const BasicPartsRegister = () => {
    ...
    const partsListLoad = useCallback(async () => {
        ...
        const res = await getRequest('http://192.168.0.21:8299/api/v1/parts/type/list', getToken(TOKEN_NAME))
    ...
    const getData = useCallback(async () => {
        ...
        const res = await getRequest('http://192.168.0.21:8299/api/v1/parts/load?pk=' + getParameter('pk'), getToken(TOKEN_NAME))
    ...
    const onsubmitFormUpdate = useCallback(async () => {
        ...
        const res = await postRequest('http://192.168.0.21:8299/api/v1/parts/update', data, getToken(TOKEN_NAME))
    ...
    const onsubmitForm = useCallback(async () => {
        ...
        const res = await postRequest('http://192.168.0.21:8299/api/v1/parts/register', data, getToken(TOKEN_NAME))
    ...
    const partsRegister = useCallback(async () => {
        ...
        const res = await postRequest('http://192.168.0.21:8299/api/v1/parts/type/register', data, getToken(TOKEN_NAME))
    ...
    const partsDelete = useCallback(async () => {
        ...
        const res = await postRequest('http://192.168.0.21:8299/api/v1/parts/type/delete', data, getToken(TOKEN_NAME))
    ...
    const partsUpdate = useCallback(async () => {
        ...
        const res = await postRequest('http://192.168.0.21:8299/api/v1/parts/type/update', data, getToken(TOKEN_NAME))
                        ...
                        <>
                            ...
                            <div style={{width: '100%', display: "flex", alignItems: "center"}}>
                                ...
                                <NormalInput title={'부품 이름'}
                                             width={partsList[type] === '부픔 등록하기' || partsList[type] === undefined ? 140 : 80}
                                             value={partsName} onChangeEvent={(input) => {
                                    console.log(input)
                                    setPartsName(input)
                                }} description={'부품명을 입력하세요'}/>
                                <div
                                    style={{marginLeft: partsList[type] === '부픔 등록하기' || partsList[type] === undefined ? 30 : 10}}>
                            ...
                            <BasicSearchContainer
                                ...
                                solo={true}
                                list={location}
                                searchUrl={'http://192.168.0.21:8299/api/v1/factory/search?'}
                            />
                            ...
                            {/*  loadDataUrl={isUpdate? `http://192.168.0.21:8299/api/v1/material/load?pk=${pk}` :''}*/}
                            ...
                            {/*    searchUrl={'http://192.168.0.21:8299/api/v1/mold/search?'}*/}
                            {/*/>*/}
