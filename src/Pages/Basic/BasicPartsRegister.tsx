...
const BasicPartsRegister = () => {
    ...
    const getData = useCallback(async()=>{
        ...
        const res = await getRequest('http://61.101.55.224:8299/api/v1/parts/load?pk=' + getParameter('pk'), getToken(TOKEN_NAME))
    ...
    const onsubmitFormUpdate = useCallback(async()=>{
        ...
        const res = await postRequest('http://61.101.55.224:8299/api/v1/parts/update', data, getToken(TOKEN_NAME))
    ...
    const onsubmitForm = useCallback(async()=>{
        ...
        const res = await postRequest('http://61.101.55.224:8299/api/v1/parts/register', data, getToken(TOKEN_NAME))
    ...
    const partsListLoad = useCallback(async()=>{
        ...
        const res = await getRequest('http://61.101.55.224:8299/api/v1/parts/type/list', getToken(TOKEN_NAME))
    ...
    const partsRegister = useCallback(async()=>{
        ...
        const res = await postRequest('http://61.101.55.224:8299/api/v1/parts/type/register', data, getToken(TOKEN_NAME))
    ...
    const partsDelete = useCallback(async()=>{
        ...
        const res = await postRequest('http://61.101.55.224:8299/api/v1/parts/type/delete', data, getToken(TOKEN_NAME))
    ...
    const partsUpdate = useCallback(async()=>{
        ...
        const res = await postRequest('http://61.101.55.224:8299/api/v1/parts/type/update', data ,getToken(TOKEN_NAME))
                ...
                <WhiteBoxContainer>
                    {
                        <>
                            ...
                            <BasicSearchContainer
                                ...
                                solo={true}
                                list={location}
                                searchUrl={'http://61.101.55.224:8299/api/v1/factory/search?'}
                            />
                            ...
                            {/*  loadDataUrl={isUpdate? `http://61.101.55.224:8299/api/v1/material/load?pk=${pk}` :''}*/}
                            ...
                            {/*    searchUrl={'http://61.101.55.224:8299/api/v1/mold/search?'}*/}
                            {/*/>*/}
