...
const BasicMoldRegister = () => {
  ...
  const onsubmitForm = useCallback(async(e)=>{
    ...
    const res = await postRequest('http://61.101.55.224:9912/api/v1/mold/register', data, getToken(TOKEN_NAME))
            ...
            <WhiteBoxContainer>
              {
                ...
                <BasicSearchContainer 
                      ...
                      solo={true}
                      list={factory}
                      searchUrl={'http://61.101.55.224:9912/api/v1/factory/search?option=1&'}
                />
                <br/>
