...
const BasicMoldRegister = () => {
    ...
    const getData = useCallback(async () => {
        ...
        const res = await getRequest('http://192.168.0.21:8299/api/v1/mold/load?pk=' + getParameter('pk'), getToken(TOKEN_NAME))
    ...
    const onsubmitForm = useCallback(async () => {
        ...
        const res = await postRequest('http://192.168.0.21:8299/api/v1/mold/register', data, getToken(TOKEN_NAME))
                ...
                <WhiteBoxContainer>
                    {
                        ...
                        <form onSubmit={isUpdate ? onsubmitFormUpdate : onsubmitForm} target={'iframe'}>
                            ...
                            {/*  loadDataUrl={isUpdate? `http://192.168.0.21:8299/api/v1/mold/load?pk=${pk}` :''}*/}
