...
const BasicMoldRegister = () => {
  ...
  const getData = useCallback(async()=>{
    ...
    const res = await getRequest('http://211.208.115.66:8091/api/v1/molde/load?pk=' + getParameter('pk'), getToken(TOKEN_NAME))
  ...
  const onsubmitForm = useCallback(async(e)=>{
    ...
    const res = await postRequest('http://211.208.115.66:PORT/api/v1/mold/register', data, getToken(TOKEN_NAME))
            ...
            <WhiteBoxContainer>
              {
                ...
                <BasicSearchContainer 
                      ...
                      solo={true}
                      list={factory}
                      searchUrl={'http://211.208.115.66:PORT/api/v1/factory/search?option=1&'}
                />
                <br/>
