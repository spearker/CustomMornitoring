...
const BasicMoldRegister = () => {
  ...
  const getData = useCallback(async()=>{
    ...
    const res = await getRequest('http://293.234.183.22:8299/api/v1/mold/load?pk=' + getParameter('pk'), getToken(TOKEN_NAME))
  ...
  const onsubmitForm = useCallback(async()=>{
    ...
    const res = await postRequest('http://293.234.183.22:8299/api/v1/mold/register', data, getToken(TOKEN_NAME))
    ...
    <DashboardWrapContainer index={'basic'}>
        ...
        <InnerBodyContainer>
            ...
            <WhiteBoxContainer>
                ...
                {/*  loadDataUrl={isUpdate? `http://293.234.183.22:8299/api/v1/mold/load?pk=${pk}` :''}*/}
