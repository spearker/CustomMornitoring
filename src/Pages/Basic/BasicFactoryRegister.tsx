...
const BasicFactoryRegister = () => {
    ...
    const getData = useCallback(async () => {
        ...
        const res = await getRequest(`http://222.100.89.245:8299/api/v1/factory/load?pk=` + getParameter('pk'), getToken(TOKEN_NAME))
    ...
    const onsubmitFormUpdate = useCallback(async () => {
        ...
        const res = await postRequest('http://222.100.89.245:8299/api/v1/factory/update', data, getToken(TOKEN_NAME))
    ...
    const onsubmitForm = useCallback(async () => {
        ...
        const res = await postRequest('http://222.100.89.245:8299/api/v1/factory/register', data, getToken(TOKEN_NAME))
        ...
        <DashboardWrapContainer index={'basic'}>
            ...
            <InnerBodyContainer>
                ...
                <WhiteBoxContainer>
                    ...
                    {/*    loadDataUrl={isUpdate? `http://222.100.89.245:8299/api/v1/factory/load?pk=${pk}` :''}*/}
