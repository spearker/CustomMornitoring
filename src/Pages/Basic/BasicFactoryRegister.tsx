...
const BasicFactoryRegister = () => {
    ...
    const getData = useCallback(async () => {
        ...
        const res = await getRequest(`http://192.168.0.21:8299/api/v1/factory/load?pk=` + getParameter('pk'), getToken(TOKEN_NAME))
    ...
    const onsubmitFormUpdate = useCallback(async (e) => {
        ...
        const res = await postRequest('http://192.168.0.21:8299/api/v1/factory/update', data, getToken(TOKEN_NAME))
    ...
    const onsubmitForm = useCallback(async (e) => {
        ...
        const res = await postRequest('http://192.168.0.21:8299/api/v1/factory/register', data, getToken(TOKEN_NAME))
                ...
                <WhiteBoxContainer>
                    {
                        ...
                        <form onSubmit={isUpdate ? onsubmitFormUpdate : onsubmitForm}>
                            ...
                            {/*    loadDataUrl={isUpdate? `http://192.168.0.21:8299/api/v1/factory/load?pk=${pk}` :''}*/}
