...
const BasicMaterialRegister = () => {
    ...
    const getData = useCallback(async () => {
        ...
        const res = await getRequest('http://192.168.0.21:8299/api/v1/material/load?pk=' + getParameter('pk'), getToken(TOKEN_NAME))
    ...
    const onsubmitFormUpdate = useCallback(async (e) => {
        ...
        const res = await postRequest('http://192.168.0.21:8299/api/v1/material/update', data, getToken(TOKEN_NAME))
    ...
    const onsubmitForm = useCallback(async (e) => {
        ...
        const res = await postRequest('http://192.168.0.21:8299/api/v1/material/register', data, getToken(TOKEN_NAME))
                ...
                <WhiteBoxContainer>
                    {
                        ...
                        <form onSubmit={isUpdate ? onsubmitFormUpdate : onsubmitForm}>
                            ...
                            <DropdownInput title={'품목 종류'}
                                           target={transferCodeToName('material', inputData.material_type)}
                                           contents={indexList}
