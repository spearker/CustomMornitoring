            ...
            <WhiteBoxContainer>
              {
                ...
                <NormalFileInput title={'기계 사진'} name={ paths[0]} thisId={'machinePhoto0'} onChangeEvent={(e)=>addFiles(e,0)} description={isUpdate ? oldPaths[0] :'기계를 사진으로 찍어 등록해주세요'} style={{width: 'calc(100% - 124px)'}} />
