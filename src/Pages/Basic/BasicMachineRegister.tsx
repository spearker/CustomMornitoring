...
const BasicMachineRegister = () => {
  ...
  const getData = useCallback(async()=>{
    ...
    const res = await getRequest('http://112.186.20.155:8299/api/v1/machine/load?pk=' + getParameter('pk'), getToken(TOKEN_NAME))
  ...
  const onsubmitFormUpdate = useCallback(async(e)=>{
    ...
    const res = await postRequest('http://112.186.20.155:8299/api/v1/machine/update/', data, getToken(TOKEN_NAME))
  ...
  const onsubmitForm = useCallback(async(e)=>{
    ...
    const res = await postRequest('http://112.186.20.155:8299/api/v1/machine/register', data, getToken(TOKEN_NAME))
            ...
            <WhiteBoxContainer>
              {
                ...
                <BasicSearchContainer
                      ...
                      solo={true}
                      list={factory}
                      searchUrl={'http://112.186.20.155:8299/api/v1/factory/search?'}
                />
                <br/>
                ...
                {/*  loadDataUrl={isUpdate? `http://112.186.20.155:8299/api/v1/machine/load?pk=${pk}` :''}*/}
