...
const BasicMachineRegister = () => {
  ...
  const getData = useCallback(async()=>{
    ...
    const res = await getRequest('http://293.234.183.22:8299/api/v1/machine/load?pk=' + getParameter('pk'), getToken(TOKEN_NAME))
            ...
            <WhiteBoxContainer>
              {
                ...
                {/*  loadDataUrl={isUpdate? `http://293.234.183.22:8299/api/v1/machine/load?pk=${pk}` :''}*/}
