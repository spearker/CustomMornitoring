...
const BasicBarcodeRegister = () => {
  ...
  const onsubmitFormUpdate = useCallback(async(e)=>{
    ...
    const res = await postRequest('http://192.168.0.47:8299/api/v1/barcode/standard/update', data, getToken(TOKEN_NAME))
  ...
  const onsubmitForm = useCallback(async(e)=>{
    ...
    const res = await postRequest('http://192.168.0.47:8299/api/v1/barcode/standard/register', data, getToken(TOKEN_NAME))
    if(res === false){
     ////alert('////alert('[SERVER ERROR] 요청을 처리 할 수 없습니다.')')
            ...
            <WhiteBoxContainer>
              {
               ...
               {/* /!*  loadDataUrl={isUpdate? `http://192.168.0.47:8299/api/v1/barcode/standard/load?pk=${pk}` :''}*!/*/}
