...
const BasicDocumentList = () => {
    ...
    const getList = useCallback(async () => {
        ...
        const results = await getRequest('http://61.101.55.224:18299/api/v1/document/list', getToken(TOKEN_NAME))
    ...
    const onClickDelete = useCallback(async (id) => {
        ...
        const results = await postRequest('http://61.101.55.224:18299/api/v1/document/delete', {pk: id}, getToken(TOKEN_NAME))
        const tg = id;
