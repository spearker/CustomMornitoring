...
const BasicStandardRegister = () => {
    ...
    const getData = useCallback(async () => {
        ...
        const res = await getRequest('http://192.168.0.21:8299/api/v1/item/load?pk=' + getParameter('pk'), getToken(TOKEN_NAME))
    ...
    const onsubmitFormUpdate = useCallback(async (e) => {
        ...
        const res = await postRequest('http://192.168.0.21:8299/api/v1/item/update', data, getToken(TOKEN_NAME))
    ...
    const onsubmitForm = useCallback(async (e) => {
        ...
        const res = await postRequest('http://192.168.0.21:8299/api/v1/item/register', data, getToken(TOKEN_NAME))
