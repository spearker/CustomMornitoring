...
const Old_OutsourcingCompanyRegister = () => {
  ...
  const getData = useCallback(async()=>{
    ...
    const res = await getRequest('http://293.234.183.22:8299/api/v1/outsourcing/load?pk=' + getParameter('pk'), getToken(TOKEN_NAME))
  ...
  const onsubmitFormUpdate = useCallback(async(e)=>{
    ...
    const res = await postRequest('http://293.234.183.22:8299/api/v1/outsourcing/update', data, getToken(TOKEN_NAME))
  ...
  const onsubmitForm = useCallback(async(e)=>{
    ...
    const res = await postRequest('http://293.234.183.22:8299/api/v1/outsourcing/register', data, getToken(TOKEN_NAME))
