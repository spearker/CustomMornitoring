...
const dummy = [
  ...
  {pk:'qwewqd2f', name:'거래처06', product_name:'제품06', manager:'홍길동', stock:'1000', price:'100,000,000', date:'2020-07-16', created:'2020-06-16', place:'서울특별시 강남구 강남동 강남아파트 123-123', condition:'선금 50% 납품시 50%'},
  {pk:'qec3qewf23', name:'거래처07', product_name:'제품07', manager:'홍길동', stock:'1000', price:'100,000,000', date:'2020-07-16', created:'2020-06-16', place:'서울특별시 강남구 강남동 강남아파트 123-123', condition:'선금 50% 납품시 50%'},
  {pk:'qecef21', name:'거래처08', product_name:'제품08', manager:'홍길동', stock:'1000', price:'100,000,000', date:'2020-07-16', created:'2020-06-16', place:'서울특별시 강남구 강남동 강남아파트 123-123', condition:'선금 50% 납품시 50%'},
]
