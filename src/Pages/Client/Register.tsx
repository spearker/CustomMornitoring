...
const ClientRegister = () => {
  ...
  const [files, setFiles] = useState<any[1]>([null]);
  ...
  },[pk, made,madeNo, type,photoName, name,oldPaths, infoList, paths ])
  ...
  },[pk, made, madeNo, name, type, madeNo, infoList, paths, ])
        ...
        <InnerBodyContainer>
            ...
            <WhiteBoxContainer>
              ...
              <div>
                ...
                <NormalInput title={'연락처'} value={phone} onChangeEvent={setPhone} description={'사업자 등록증에 기재되어있는 연락처를 입력하세요'} />
                <br/>
                ...
                <NormalInput title={'팩스'} value={fax} onChangeEvent={setFax} description={'사업장 팩스번호를 입력하세요'} />
