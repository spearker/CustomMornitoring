...
const RegisterSubMachine = () => {
  ...
  const getData = useCallback(async()=>{
    ...
    const res = await getRequest('http://192.168.0.47:8299/api/v1/peripheral/view?pk=' + getParameter('pk'), getToken(TOKEN_NAME))
  ...
  const onsubmitFormUpdate = useCallback(async(e)=>{
    ...
    const data = {
      ...
      const res = await postRequest('http://192.168.0.47:8299/api/v1/peripheral/update', data, getToken(TOKEN_NAME))
  ...
  const onsubmitForm = useCallback(async(e)=>{
    ...
    const res = await postRequest('http://192.168.0.47:8299/api/v1/peripheral/register' + pk, data, getToken(TOKEN_NAME))
