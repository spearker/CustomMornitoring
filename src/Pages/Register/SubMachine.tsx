          ...
          <InnerBodyContainer>
            ...
            <WhiteBoxContainer>
              <form onSubmit={onsubmitForm} >
                <NormalInput title={'주변장치 이름'} value={name} onChangeEvent={setName} description={'고객사가 보유한 기계의 이름을 입력하세요'} />
                <NormalInput title={'주변장치 종류'} value={type} onChangeEvent={setType} description={'고객사가 보유한 기계의 종류를 입력하세요'} />
                <NormalInput title={'주변장치 번호'} value={no} onChangeEvent={setNo} description={'고객사가 보유한 기계의 번호를 지정하세요'} />
                ...
                <NormalFileInput title={'주변장치 사진'} name={photoName} thisId={'SubMachinePhoto'} onChangeEvent={addFile} description={'기계 사진을 찍어 올려주세요 (없을시 기본 이미지)'} />
                <RegisterButton name={'주변장치 정보 등록하기'} />
              </form>
            </WhiteBoxContainer>
