...
const RegisterLine = () => {
    ...
    const onClickSearch = useCallback(async (e) => {
        ...
        const res = await getRequest('http://222.100.89.245:8299/api/v1/procedure/search?keyword=' + keyword, getToken(TOKEN_NAME))
    ...
    const onClickSearch2 = useCallback(async (e) => {
        ...
        const res = await getRequest('http://222.100.89.245:8299/api/v1/peripheral/search?keyword=' + keyword, getToken(TOKEN_NAME))
