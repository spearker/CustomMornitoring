...
const RegisterMaterial = () => {
  ...
  const getData = useCallback(async () => {
    ...
    const res = await getRequest('http://183.99.194.242:8299/api/v1/material/view?pk=' + getParameter('pk'), getToken(TOKEN_NAME))
  ...
  const onsubmitForm = useCallback(async (e) => {
    ...
    const res = await postRequest('http://183.99.194.242:8299/api/v1/material/register', data, getToken(TOKEN_NAME))
  ...
  const onsubmitFormUpdate = useCallback(async (e) => {
    ...
    const res = await postRequest('http://183.99.194.242:8299/api/v1/material/update', data, getToken(TOKEN_NAME))
