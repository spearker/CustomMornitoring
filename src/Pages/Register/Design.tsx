...
const RegisterDesign = () => {
    ...
    const getData = useCallback(async () => {
        ...
        const res = await getRequest('http://61.101.55.224:18299/api/v1/mold/view?pk=' + getParameter('pk'), getToken(TOKEN_NAME))
    ...
    const onsubmitForm = useCallback(async (e) => {
        ...
        const res = await postRequest('http://61.101.55.224:18299/api/v1/mold/register' + pk, data, getToken(TOKEN_NAME))
