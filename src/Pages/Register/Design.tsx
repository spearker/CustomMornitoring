...
const RegisterDesign = () => {
  ...
  const getData = useCallback(async ()=>{
    ...
    const res = await getRequest('http://192.168.0.47:8299/api/v1/mold/view?pk=' + getParameter('pk'), getToken(TOKEN_NAME))
  ...
  const onsubmitForm = useCallback(async(e)=>{
   ...
   // return;
    ...
    const res = await postRequest('http://192.168.0.47:8299/api/v1/mold/register' + pk, data, getToken(TOKEN_NAME))
