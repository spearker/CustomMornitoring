...
const RegisterBarcode = () => {
    ...
    const getData = useCallback(async () => {
        ...
        const res = await getRequest('http://222.100.89.245:8299/api/v1/barcode/view?pk=' + getParameter('pk'), getToken(TOKEN_NAME))
    ...
    const onsubmitForm = useCallback(async (e) => {
        ...
        const res = await postRequest('http://222.100.89.245:8299/api/v1/barcode/register', data, getToken(TOKEN_NAME))
    ...
    const onsubmitFormUpdate = useCallback(async (e) => {
        ...
        const res = await postRequest('http://222.100.89.245:8299/api/v1/barcode/update', data, getToken(TOKEN_NAME))
