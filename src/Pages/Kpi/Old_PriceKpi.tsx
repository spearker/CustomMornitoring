...
const Old_PriceKpi = () => {
  ...
  const getSearchList = useCallback(async (e)=>{
    ...
    const results = await getRequest('http://112.186.20.155:8299/api/v1/barcode/list?orderBy=' + option + '&keyword=' + keyword,getToken(TOKEN_NAME))
  ...
  const onClickDelete = useCallback(async (id)=>{
    ...
    const results = await postRequest('http://112.186.20.155:8299/api/v1/barcode/delete', {pk:id}, getToken(TOKEN_NAME))
    const tg = id
