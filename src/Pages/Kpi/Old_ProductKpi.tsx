...
const Old_ProductKpi = () => {
    ...
    const getSearchList = useCallback(async (e) => {
        ...
        const results = await getRequest('http://112.168.150.239:8299/api/v1/barcode/list?orderBy=' + option + '&keyword=' + keyword, getToken(TOKEN_NAME))
    ...
    const onClickDelete = useCallback(async (id) => {
        ...
        const results = await postRequest('http://112.168.150.239:8299/api/v1/barcode/delete', {pk: id}, getToken(TOKEN_NAME))
        const tg = id
            ...
            <InnerBodyContainer>
                ...
                <div style={{display: 'flex', width: '100%', marginTop: 22}}>
                    <ChartBox id="chart">
                        ...
                        <Chart options={option_timeperproduce.options} series={option_timeperproduce.series} type="line"
                               height={320}/>
                    </ChartBox>
                ...
                <div style={{display: 'flex', width: '100%', marginTop: 22}}>
                    ...
                    <ChartBox id="chart">
                        ...
                        <Chart options={option_leadtime.options} series={option_leadtime.series} type="bar"
                               height={240}/>
                    </ChartBox>
                    <ChartBox id="chart">
