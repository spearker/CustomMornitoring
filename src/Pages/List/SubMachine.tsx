...
const SubMachineList = () => {
  ...
  const getSearchList = useCallback(async (e)=>{
    e.preventDefault();
    const results = await getRequest('http://192.168.0.47:8299/api/v1/peripheral/list/search?page='+page+'&keyword='+ keyword +'&type=' + option ,getToken(TOKEN_NAME))
  ...
  const getList = useCallback(async ()=>{
    ...
    const results = await getRequest('http://192.168.0.47:8299/api/v1/peripheral/list?page='+page+'&keyword='+ keyword +'&type=' + option, getToken(TOKEN_NAME))
  ...
  const onClickDelete = useCallback(async (id)=>{
    ...
    const results = await postRequest('http://192.168.0.47:8299/api/v1/peripheral/delete', {pk:id}, getToken(TOKEN_NAME))
    const tg = id
