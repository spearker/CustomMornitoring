...
const SubMachineList = () => {
  ...
  const getSearchList = useCallback(async (e)=>{
    e.preventDefault();
    const results = await getRequest('http://211.208.115.66:8091/api/v1/peripheral/list/search?keyword='+ keyword +'&orderBy=' + option ,getToken(TOKEN_NAME))
  ...
  const getList = useCallback(async ()=>{
    ...
    const results = await getRequest('http://211.208.115.66:8091/api/v1/peripheral/list?keyword='+ keyword +'&orderBy=' + option, getToken(TOKEN_NAME))
  ...
  const onClickDelete = useCallback(async (id)=>{
    ...
    const results = await postRequest('http://211.208.115.66:8091/api/v1/peripheral/delete', {pk:id}, getToken(TOKEN_NAME))
    const tg = id
