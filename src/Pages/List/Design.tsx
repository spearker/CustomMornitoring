...
const DesignList = () => {
  ...
  const getList = useCallback(async ()=>{
    ...
    const results = await getRequest(BASE_URL + '/api/v1/mold/list/0',getToken(TOKEN_NAME))
  ...
  const onClickFilter = useCallback(async (filter:number)=>{
    ...
    const results = await getRequest(BASE_URL + '/api/v1/mold/list/' + filter,getToken(TOKEN_NAME))
