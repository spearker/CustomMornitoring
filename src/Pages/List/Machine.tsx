...
const MachineList = () => {
  ...
  const getList = useCallback(async ()=>{
    ...
    const results = await getRequest(BASE_URL + '/api/v1/machine/list/0',getToken(TOKEN_NAME))
  ...
  const onClickFilter = useCallback(async (filter:number)=>{
    ...
    const results = await getRequest(BASE_URL + '/api/v1/machine/list/' + filter,getToken(TOKEN_NAME))
