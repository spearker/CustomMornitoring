            ...
            <InnerBodyContainer>
                ...
                <WhiteBoxContainer>
                    <form onSubmit={isUpdate ? onsubmitFormUpdate : onsubmitForm}>
                        {
                            isUpdate ?
                                <NormalInput title={'이름'} value={tempInfo !== undefined ? tempInfo.name : ''}
                                             description={''}/>
                                :
                                <>
                                    <div style={{
                                    ...
                                    {/* 팝업 여는 버튼 + 보전 주변장치 추가 */}
                                    {
                                        type === 'peripheral' ?
                                            ...
                                            <AddInput title={'보전 주변장치'} icType="solo"
                                    ...
                                    {
                                        type === 'mold' ?
                                            <AddInput title={'보전 금형'} icType="solo"
                                                      onlyOne={list2.length > 0 ? true : false}
                                                      onChangeEvent={() => {
                                                          setIsPoupup2(true);
                                                          setCheckList2(list);
                                                          setKeyword('')
                                    ...
                                    {
                                        type === 'machine' ?
                                            <AddInput title={'보전 기계'} icType="solo"
                                                      onlyOne={list3.length > 0 ? true : false}
                                                      onChangeEvent={() => {
                                                          setIsPoupup3(true);
                                                          setCheckList3(list3);
                                                          setKeyword('')
