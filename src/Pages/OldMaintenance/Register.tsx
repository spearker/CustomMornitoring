...
const RegisterMaintenance = () => {
  ...
  const getData = useCallback(async () => {
    ...
    const res = await getRequest('http://192.168.0.46:8299/api/v1/preserve/view?pk=' + getParameter('pk') + '&type=' + getParameter('type'), getToken(TOKEN_NAME))
  ...
  const onsubmitForm = useCallback(async (e) => {
    ...
    const res = await postRequest('http://192.168.0.46:8299/api/v1/preserve/register', data, getToken(TOKEN_NAME))
  ...
  const onsubmitFormUpdate = useCallback(async (e) => {
    ...
    const res = await postRequest('http://192.168.0.46:8299/api/v1/preserve/update', data, getToken(TOKEN_NAME))
  ...
  const onClickSearch = useCallback(async (e) => {
    ...
    const res = await getRequest(`http://192.168.0.46:8299/api/v1/common/search?keyword=${keyword}&type=${type}&orderBy=1`, getToken(TOKEN_NAME))
