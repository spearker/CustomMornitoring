...
const RegisterMaintenance = () => {
  ...
  const getData = useCallback(async () => {
    ...
    const res = await getRequest('http://61.101.55.224:18299/api/v1/preserve/view?pk=' + getParameter('pk') + '&type=' + getParameter('type'), getToken(TOKEN_NAME))
  ...
  const onsubmitForm = useCallback(async (e) => {
    ...
    const res = await postRequest('http://61.101.55.224:18299/api/v1/preserve/register', data, getToken(TOKEN_NAME))
  ...
  const onsubmitFormUpdate = useCallback(async (e) => {
    ...
    const res = await postRequest('http://61.101.55.224:18299/api/v1/preserve/update', data, getToken(TOKEN_NAME))
