...
const MyPage = () => {
  ...
  const onClickSave = useCallback(async () => {
    ...
    const results = await postRequest('http://112.168.150.239:8299/api/v1/member/profile', data, getToken(TOKEN_NAME))
  ...
  const getTarget = useCallback(async () => {
    ...
    const results = await getRequest('http://112.168.150.239:8299/api/v1/member/view?pk=' + encodeURIComponent(User.email), getToken(TOKEN_NAME))
