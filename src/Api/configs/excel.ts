...
import {SF_ENDPOINT, SF_ENDPOINT_EXCEL} from '../SF_endpoint'
...
client.defaults.baseURL = SF_ENDPOINT_EXCEL + '/api'
...
const getErrorCase = (code, message) => {
    switch (code) {
        ...
        default:
            Notiflix.Loading.Remove(300)
            return Notiflix.Report.Failure('요청 실패', message, '닫기', () => window.location.reload())
    }
}
